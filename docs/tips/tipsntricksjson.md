...
> [!NOTE]
> To include double quotes in escaped content, place a backslash ( `\` ) in front of them. Like so:<br><br>`"He asked, \"What's up doc?\""`
...
Note that the values in first half of the array have been converted into their native formats, including booleans, numbers, and dates. The second half are escaped and all exported as standard strings.